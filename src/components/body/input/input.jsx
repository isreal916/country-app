 ...
 export default function Input({handleInput}){ 
  ...
  return(
    <div className="input-container" >
      ...
      <div className="input-container-select"style={(isDarkmode)?{backgroundColor:'hsl(209, 23%, 22%)',color:'white'}:{backgroundColor:'white',color:'black', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>
        <select name="select" id="" onChange={(ev)=>handleInput(ev)}>
